...
可参考 `org.springframework.ai.transformer.splitter.TokenTextSplitter`
继承`TextSplitter`基类实现一个自定义文档分割器。

### 学校规章制度专用文档分割器

[RegulationDocumentSplitter.java](../01-quick-start/src/main/java/com/zhengqing/saa/splitter/RegulationDocumentSplitter.java)
...
效果：
![](./images/23-RAG-自定义文档分割器_1760095105578.png)
