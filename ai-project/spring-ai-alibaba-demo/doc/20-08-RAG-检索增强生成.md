...
RetrievalAugmentationAdvisor 是 Spring AI 中实现检索增强生成（RAG）的核心组件，其作用是通过智能检索外部知识库并动态增强大模型生成上下文，解决大模型幻觉问题和知识局限性。

[_23_RagRetrievalAugmentationAdvisorController.java](../01-quick-start/src/main/java/com/zhengqing/saa/api/_23_RagRetrievalAugmentationAdvisorController.java)
...
效果：
![](./images/20-08-RAG-检索增强生成_1760181409345.png)
